...
public class Demographics {
    public static void main(String[] args) {
        ...
        person3.put("Age", "22"); person3.put("Gender", "male");
        person3.put("City", "Skokie");

        HashMap<String, String> person4 = new HashMap<>();
        person4.put("FirstName", "Prianka"); person4.put("LastName", "Khan");
        person4.put("Age", "23"); person4.put("Gender", "female");
        ...
        person5.put("Age", "25"); person5.put("Gender", "female");
        ...
        // Each day person came record temperature inside your data structure use maps
    }
}
